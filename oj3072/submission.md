...
```text
Step 1: รับค่า text
Step 2: สร้าง array มาเก็บสระ
Step 3: เช็คว่ามีสระใน text ไหม
Step 4: ถ้ามีแล้ว output ต้องเป็นสระที่มีและจำนวน
```
...
```text
เหมือนวิธีแรกรับค่า text และสร้าง array มาเก็บสระเช็คว่ามีสระใน text ไหมถ้ามีแล้ว output ต้องเป็นสระที่มีและจำนวน รวมซ้ำกันด้วย
```
...
```text
oooo เช็คว่าถ้ามีแค่สระจะเป็นยังไง
```
...
```text
k()e เช็คว่าถ้ามีอักษรพิเศษจะเป็นอะไรไหม
```
