...
```text
โจทย์ให้คิดราคาว่าแต่ะครต้องจ่ายเทาไหร่ โดยมีทั้งได้ส่วนลดและไม่ได้ส่วนลด

Input:
สถานะว่าเป็นสมาชิกไหม "N" = เป็น  "Y" = ไม่เป็น

Output:
ราคาสินค้าที่ต้องจ่าย(ทศนิยม 2 ตำแหน่งโดยปัดเศษจากตำแหน่งที่ 3 ขึ้นมาที่ตำแหน่งที่ 2)

Constraints:
เช็คว่าถ้าไม่ซื้อสินค้าเลยจะเป็นยังไง(0)
```
...
```text
Step 1:รับสถานะมาว่าเป็นสมาชิกไหม
Step 2: อินพุทจำนวนของที่จะซื้อ
Step 3: for loop วน เผื่อรับสินค้ามาคิดตามจำนวนที่กรอกไว้ พร้อมทั้งคิด ราคาเลย
Step 4:โดยถ้าตรงเงื่อนไขเป็นสมาชิกจะได้ลดราคาทันทีจากราคารวมทั้งหมด 5%
Step 5:ถ้าตรงเงื่อนไขไม่เป็นสมาชิกต้องเช็คว่าทั้งหมดซื้อ 500 ขึ้นไปไหม
Step 6:ถ้าไม่ให้จ่ายเต็มราคา ถ้า เกินให้ส่วนลด 3%
Step 7:แสดงผลเป็นราคาทั้งหมด
...
```text
เหมือนโค้ดเดิมแต่ต้องคิดตรง output ใหม่ โดยการคูณ 100 เข้าไปแล้วปัดเศษขึ้นด้วย math.ceil() (ต้อง import math ก่อน) จากนั้นหาร 100 คืนเพื่อให้เป็นทศนิยม 2 ตำแหน่ง
```
...
```text
เช็คกรณีที่สินค้าทุกอันราคา 0 บาท ว่าโค้ดจะทำงานยังไง
```
...
```text
เช็คกรณีที่สินค้าบางอันเป็น 0 เผื่อมีข้อผิดพลาด
```
