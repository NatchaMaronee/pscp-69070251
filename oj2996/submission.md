...
```text
โจทย์มห้นำเข้า string input 5 ตัวอักษร โดย output ที่แสดงตัวอักษรจะอ่านย้อนหลังและเป็นได้แค่ตัวพิมพ์เล็กเท่านั้น หาก input เป็นตัวพิมพ์ใหญ่จะต้องเปลี่ยนเป็นพิมพ์เล็กด้วย

Input:
รับ string 5 ตัวอักษร

Output:
ได้ string ที่เรียงแถวใหม่จากหลังไปหน้าและเปลี่ยนเป็นตัวพิมพ์เล็กทั้งหมด

Constraints:
input เป็น string output ต้องเป็นตัวพิมพ์เล็กเท่านั้น ทดลองใส่ input เป็นตัวพิมพ์ใหญ่แล้วดูว่าเปลี่ยนเป็นพิมพ์เล็กไหม
```
...
```text
Step 1: ใส่ input
Step 2: ถ้าเป็น string ใช้ input() ปกติได้ ได้ค่า string แน่ ๆ
Step 3: นำ string มาย้อน index (จากหลังไปหน้า)
Step 4: นำ string ที่ย้อนแล้วมา lower ตัวอักษร
```
...
```text
วิธีสุดท้ายเหมือนแผนแรก ใช้ input() ปกติรับค่า string เข้ามา ถ้าใส่ค่า string ตามปกติจะไม่เกิดอะไร ไปต่อที่การสลับตัวอักษรจากหลังไปหน้า และนำมา lower ให้เป็นพิมพ์เล็ก
```
...
```text
เช็คว่าเปลี่ยนพิมพ์ใหญ่เป็นพิมพ์เล็กได้จริงไหม
```
...
```text
อยากลองว่าถ้าใส่ int รวมกับ string เข้่าไปจะมีปัญหาไหม
```
...
```text
เช็คว่าพิมพ์ใหญ่ทั้งหมดสามารถเปลี่ยนเป็นพิมพ์เล็กได้ เผื่อเกิดเหตุที่เปลี่ยนได้ไม่ครบทุกตัว
```
