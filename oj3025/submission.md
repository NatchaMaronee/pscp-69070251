...
```text
รับค่า input 2 ค่า ค่า เดือน วัน แล้วนำมาคิดฤดู

Input:
รับ input 2 ตัว 

Output:
โปรแกรมควรพิมพ์ฤดูออกมาตามเลขเดือนกับวันตามเงื่อนไข
...
```text
Step 1: นับค่า เดือน วัน
Step 2: ตรวจว่า เดือนกับวันตรงตามเงื่อนไขฤดูอะไร ถ้าวันเกิน  21  ให้ขึ้นเดือนใหม่
Step 3: output  เป็นฤดู
```
...
```text
เหมือนแผนแรก เช็คเดือนปี และเช็คว่าวันที่มากกว่าหรือน้อยกว่า  21 และเปลี่ยนเดือน ถ้าน้อยกว่าให้อยู่เดือนเดิม มากกว่าให้ขึ้นเดือนใหม่ และเป็นเดือนเลขคี่
```
...
```text
เช็ค เดือนที่ 3 วันที่ 21 เผื่อเช็คว่าจะเปลี่ยนฤดูไหม
```
...
```text
เช็ค เดือนที่ 1 วันที่ 21 เผื่อเช็คว่าโปรแกรมทำงานถูกต้อง
```
...
```text
เช็ค เดือนที่ 12 วันที่ 21 เผื่อเช็คว่าจะเปลี่ยนฤดูไหม
```
