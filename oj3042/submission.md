...
```text
โจทย์รับค่า n แล้วแสดงจำนวนระหว่าง 0-n ที่หาร 10 ลงตัว แต่เรียงกลับด้าน

Input:
โปรแกรมรับจำนวนเต็มหนึ่งค่า n

Output:
ค่า 0-n ที่หาร 10 ลงตัว

Constraints:
พิจารณา 0 ว่าจะออกมาเป็น 0 ไหม เผื่อนำไปคิดผิด
```
...
Step 2: นำ n ไปหารเอาส่วน เพื่อกันกรณีหารได้เศษแล้วนำไปคูณ 10
Step 3: นำค่าที่หารเอาส่วนแล้วมาหาร 10 เรียงจากหลังมาหน้าใน  n
Step 4: output ได้ n ที่หาร 10 ลงตัว
```
...
```text
วิธีสุดท้ายเหมือนวิธีแรก นำค่า n มาหาร 10 จากนั้นใช้ range เรียงจาก  n มา 0 แล้วแสดงค่า n ทั้งหมดที่หาร 0 ลงตัว
```
...
```text
เช็คค่า 0 ว่าได้ จ ไหม เผื่อคิดเลขผิด
```
...
```text
เช็ค 100 ว่าโปรแกรมทำงานถูกต้องไหม
```
...
```text
เช็ค 145 ว่าได้แค่ค่าหาร 10 ลงตัวไหม
```
