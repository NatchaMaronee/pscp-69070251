...
```text
โจทย์ให้รับค่าเงินที่รวมราคาทุกอย่างแล้ว สิ่งที่เราต้องเอาไปคิดต่อคือค่าบริการและภาษี

Input:
รับจำนวนเต็มที่เป็นราคารวมที่เราซื้อ

Output:
ราคารวมของราคาที่ต้องจ่าย + ค่าบริการ + ภาษี

Constraints:
คิดกรณีที่ INPUT เป็น 0 ด้วย เผื่อเมื่อเข้าสู่การคิดเลขแล้วจะผิด
```
...
```text
Step 1: รับค่า input
Step 2: ตรวจว่า n *0.1 < 50 ไหม
Step 3: ถ้าน้อยกว่าให้เอาราคารวม + 50 ไปเลยเพราะต่ำสุดค่าบริการต้องคิด 50 
Step 4: จากนั้น + ภาษี 7%
Step 5: print out put
```
...
```text
เหมือนวิธีแรกแต่เติมเงื่อนไขอื่น ๆ เข้าไปด้วย เริ่มด้วยรับค่า input เข้่่ามา ถ้าคูณ 0.1 น้อยกว่า 50 (if) ให้เอา 50 ไปใข้เลย ถ้า input = 0 (elif) ให้ output มีค่าเป็น 0 เลย ถ้าคูณ 0.1 มากกว่า 1000 (elif) ทำเหมือนกรณีแรกแต่เปลี่ยนเป็นบวก 1000 ไปเลย นอกเหนือจากนั้นให้(else) + ด้วยค่า 0.1 เต็ม ๆ ไปเลย บวกท้ายด้วยภาษีและปริ้นค่าออกมา
```
...
```text
input = 0 เพราะจะเช็คว่าเมื่ออนำไปคิดเลขจะออกมาเป็น 0 ไหม
```
...
```text
input = 50 เช็คว่าถ้าค่าบริการน้อยกว่า 50
```
