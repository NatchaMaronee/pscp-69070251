...
```text
รับค่าคะแนนรวมสามคนกับคะแนนสูงสุดแล้วนำไปคิดว่าโอกาสออกมา surprising or not

Input:
รับค่าคะแนนรวมสามคนกับคะแนนสูงสุด

Output:
 surprising or not

Constraints:
พิจารณา 0 gเพราะต้องปัดผมต่างค่า min max เป็น 0 ให้ไม่ติดลบ
```
...
```text
Step 1: รับค่าคะแนรวมและค่าสูงสุด
Step 2: หักคะแนนสูงสุดสองค่าออกจากคะแนนรวมแล้วจะได้ min
Step 3: ถ้า min > 2 จะออกมา surprising น้อยกว้่านั้น not surprising
...
```text
ใช้วิธีเดิม รับค่าคะแนนรวมและค่าสูงสุดหักคะแนนสูงสุดสองค่าออก จากคะแนนรวมแล้วจะได้ min ถ้า min > 2 จะออกมา surprising น้อยกว้่านั้น not surprising
...
```text
50, 30 เช็คว่าโปรแกรมทำงานถูกต้แงไหม
```
...
```text
เช็คค่า 0 0 ว่าจะออกมาเป็นอย่างไร
```
...
```text
เข็ค 1 1 เช็คว่าโปรแกรมทำงานถูกต้องไหม
```
