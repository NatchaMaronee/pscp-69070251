...
```text
โจทย์ให้เราค่าอุณหภูมิและหน่ยแรกเข้ามา หลังจากนั้นให้แปลงเป็นหน่วยที่ต้องการ

Input:
ค่าอุณหภูมิ หน่วยอุณหภูมิแรก หน่วยอุณหภูมิที่อยากได้

Output:
ค่าที่แปลงแล้ว โดยเป็นทศนิยม 2 ตำแหน่ง

Constraints:
เช็คกณีที่เป็นหน่วยอุณหภูมิเดียวกัน
```
...
```text
Step 1: รับค่าอุณหภูมิและหน่วยอุณหภูมิที่อยากได้
Step 2: นำไปเช็คว่าแปลงเป็นหน่วยไหนแล้วจากหน่วยอะไร
Step 3: แปลงค่าอุณหภูมิและส่งออกตัวเลข
...
```text
วิธีสุดท้ายของเหมือนกับแผนแรก แค่ตอนแรกจะเขียนโค้ดยาวและซ้ำซ้อนกว่าซึ่งไม่เหมาะ เพิ่งมาสังเกตว่าสามารถรวบรัดได้ เช็คทีเดียวและเช็คอีกเงื่อนไขทีเดียว โดยการรักค่าอุณหภูมิและหน่วยแรกเข้ามาจากนั้นจะแปลงค่าเป็น C เผื่อจะไปคำนวณต่อไปในหน่วยที่ต้องการ จากนั้นแสดงค่าที่ได้จากการคำนวณ
```
...
```text
เช็คว่าถ้าหน่วยเหมือนกันจะได้ค่าเดิมไหม
```
...
```text
เช็คว่าโปรแกรมทำงานถูกต้องไหม เพื่อเช็คการแปลงค่าให้ครบถ้วน
```
