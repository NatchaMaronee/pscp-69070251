...
```text
โจทย์ให้หาจำนวนของอิฐก้อนเล็กที่ใช้ที่น้อยที่สุด เพราะจะเลือกใช้อิฐก้อนใหญ่ก่อนเสมอ

Input:
จำนวน อิฐก้อน เล็ก ใหญ่ขนาดที่ต้องสร้าง

Output:
ถ้าส้รางได้ตามที่ต้องการให้แสดงจำนวนอิฐเล็กที่ใช้ไป

Constraints:
ลองเช็คกรณีที่ทั้งอิฐก้อนเล็ก ใหญ่เป็น 0
```
...
```text
Step 1: เช็คค่าอิฐก้อนใหญ่ว่ามากกว่า 0 ไหม ถ้ามากกว่าให้ไปคิดอีกว่าจำนวนอิฐใหญ่ที่มีพอใช้จนครบไหม
Step 2: ถ้าไม่นำพท.ที่ต้องการลบกับพท.ทั้งหมดที่อิฐก้อนใหญ่ให้ได้ ถ้าส่วนที่เหลือพอที่อิฐเล็กจะเติมได้ให้แสดงค่าเป็นจำนวนอิฐก้อนเล็ก แต่ถ้ามากกว่าอิฐก้อนเล็กให้แสดง -1
Step 3: แต่ถ้าพท.มีมากกว่าที่อิฐก้อนใหญ่จะเติมได้ ให้เช็คว่าอิฐเล็กจะเติมพอไหม ถ้าพอให้แสดงจำนวนอิฐเล็ก ไม่พอให้แสดง -1
Step 4: เงื่อนไขนอกจากที่ก้อนใหญ่ไม่มีเลยจะมาอยู่ใน else เช็คว่าถ้าใช้ก้อนเล็กได้หมดพอดีก็แสดงจำนวนกินเล็ก ถ้าไม่ -1
```
...
```text
วิธีเดิม เช็คค่าอิฐก้อนใหญ่ว่ามากกว่า 0 ไหม ถ้ามากกว่าให้ไปคิดอีกว่าจำนวนอิฐใหญ่ที่มีพอใช้จนครบไหม
ถ้าไม่นำพท.ที่ต้องการลบกับพท.ทั้งหมดที่อิฐก้อนใหญ่ให้ได้ ถ้าส่วนที่เหลือพอที่อิฐเล็กจะเติมได้ให้แสดงค่าเป็นจำนวนอิฐก้อนเล็ก แต่ถ้ามากกว่าอิฐก้อนเล็กให้แสดง -1 แต่ถ้าพท.มีมากกว่าที่อิฐก้อนใหญ่จะเติมได้ ให้เช็คว่าอิฐเล็กจะเติมพอไหม ถ้าพอให้แสดงจำนวนอิฐเล็ก ไม่พอให้แสดง -1 เงื่อนไขนอกจากที่ก้อนใหญ่ไม่มีเลยจะมาอยู่ใน else เช็คว่าถ้าใช้ก้อนเล็กได้หมดพอดีก็แสดงจำนวนกินเล็ก ถ้าไม่ -1
```
...
```text
เช็คว่าถ้าไม่มีอิฐใหญ่เลยจะสร้างได้ไหม
```
...
```text
เช็คว่าถ้าไม่มีอิฐเลยจะเป็น -1 ไหม
```
...
```text
เช็คว่าถ้ามีอิฐก้อนใหญ่พอสร้างแต่ต้องการก้อนเล็กเพิ่มก้อนเล็กจะเติมตามจำนวนแบบไม่เกินไหม
```
